...
import { getSingleOrderDetails ,removeErrors } from '../features/order/orderSlice'
...
function OrderDetails() {
   ...
   useEffect(()=>{
    ...
    const orderStatusClass=finalOrderStatus==='Delivered'?'status-tag delivered':`status-tag ${finalOrderStatus}`
                ...
                <table className="table-main">
                    <tbody>
                        <tr className="table-row">
                            ...
                            <td className="table-cell">{shippingInfo?.address},{shippingInfo?.city},{shippingInfo?.state},
